...
#print(esConAgg("dest"))
def main(utcStart):
    with PdfPages('CMS_Bytes.pdf') as pc:
        d = pc.infodict()
                ...
                for pong in destSites:
                    ...
                    if not type(qResults) == type(None):
                        ...
                        if srcThrough.size > 0:
                            ...
                            axsT[0].set_ylabel("DiskUsage")
                            axsT[1].set_ylabel("BytesRecvd")
                        ...
                        if destThrough.size > 0:
                            ...
                            axdT[0].set_ylabel("DiskUsage")
                            axdT[1].set_ylabel("BytesRecvd")
                        ...
                        if srcPacket.size > 0:
                            ...
                            axsP[0].set_ylabel("DiskUsage")
                            axsP[1].set_ylabel("BytesRecvd")
                        ...
                        if destPacket.size > 0:
                            ...
                            axdP[0].set_ylabel("DiskUsage")
                            axdP[1].set_ylabel("BytesRecvd")
                        ...
                        if srcLatency.size > 0:
                            ...
                            axL[0].set_ylabel("DiskUsage")
                            axL[1].set_ylabel("BytesRecvd")
                        ...
                        if destLatency.size > 0:
                            ...
                            axP[0].set_ylabel("DiskUsage")
                            axP[1].set_ylabel("BytesRecvd")
